...
namespace ContosoUniversityTARpe21
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (instructor != null)
            {
                // Before removing instructor, reassign or nullify departments they administer.
                var departmentsAdministeredByInstructor = _context.Departments
                    .Where(d => d.InstructorID == instructor.ID);

                foreach (var department in departmentsAdministeredByInstructor)
                {
                    department.InstructorID = null;  // Set to null or assign it to another instructor.
                }
